...
name: FixTests
version: 0.1.0
description: "Run tests and systematically fix all failing tests using smart error grouping. USE WHEN tests are failing, user asks to fix failing tests, CI reports test failures, or a test suite run leaves failures."
allowed-tools: Read, Edit, Bash, Grep, Glob
upstream: https://raw.githubusercontent.com/davila7/claude-code-templates/main/cli-tool/components/skills/development/test-fixing/SKILL.md
---
